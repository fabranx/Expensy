...
const PaymentAccountSchema = CollectionSchema(
  ...
  links: {
    r'expense': LinkSchema(
      id: -6795255091496277842,
      name: r'expense',
      target: r'Expense',
      single: false,
      linkName: r'paymentAccount',
    )
  },
  embeddedSchemas: {},
...
extension PaymentAccountQueryWhere
  ...
  QueryBuilder<PaymentAccount, PaymentAccount, QAfterWhereClause> nameEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
...
extension PaymentAccountQueryLinks
    on QueryBuilder<PaymentAccount, PaymentAccount, QFilterCondition> {
  QueryBuilder<PaymentAccount, PaymentAccount, QAfterFilterCondition> expense(
  ...
  QueryBuilder<PaymentAccount, PaymentAccount, QAfterFilterCondition>
      expenseLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
