...
const ExpenseSchema = CollectionSchema(
  ...
  links: {
    ...
    r'paymentAccount': LinkSchema(
      id: -8814559908092817573,
      name: r'paymentAccount',
      target: r'PaymentAccount',
      single: true,
    )
  },
  embeddedSchemas: {},
...
List<IsarLinkBase<dynamic>> _expenseGetLinks(Expense object) {
  return [object.tags, object.paymentAccount];
}
...
void _expenseAttach(IsarCollection<dynamic> col, Id id, Expense object) {
  ...
  object.paymentAccount.attach(
      col, col.isar.collection<PaymentAccount>(), r'paymentAccount', id);
}
...
extension ExpenseQueryLinks
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> paymentAccount(
      FilterQuery<PaymentAccount> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'paymentAccount');
    });
  }

  QueryBuilder<Expense, Expense, QAfterFilterCondition> paymentAccountIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'paymentAccount', 0, true, 0, true);
    });
  }
}
